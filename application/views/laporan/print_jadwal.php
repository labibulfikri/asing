 <!-- Favicons-->
    ...
    <link href="<?php echo base_url()?>assets/icon_fonts/css/all_icons_min.css" rel="stylesheet">
    ...
    <link href="<?php echo base_url()?>assets/assets/vendor/line-awesome/css/line-awesome.min.css" rel="stylesheet">
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/assets2/icons/fontawesome/fontawesome.css"> 
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/assets2/icons/spinnericon/spinnericon.css">
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/assets2/icons/fontawesome/fontawesome.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/assets2/icons/linecons/linecons.css"> 
...
<script src="<?php echo base_url()?>assets/assets/js/jquery-2.2.4.min.js"></script> 
    ...
    <script src="<?php echo base_url()?>assets/assets/vendor/jquery-sticky/jquery.sticky.js"></script>
...
<!-- time -->
<link href='http://weareoutman.github.io/clockpicker/dist/jquery-clockpicker.min.css' type='text/css' rel='stylesheet'>
...
<script src="//cdn.ckeditor.com/4.13.0/standard/ckeditor.js"></script>
    ...
    <link href="<?php echo base_url()?>assets/assets/css/style.css" rel="stylesheet">
		...
		<div class="container margin_60"> 
			...
			<div class="row"> 
				<div class="message">
					<center> <strong> Perkara Litigasi yang ditangani Bidang PSP DPBT </strong></center>
                    <label> Laporan Jadwal :  </label></br>
                    <label> Dari Tanggal : <?php echo $tgl1?></label> </br>
                    <label> Sampai Tanggal : <?php echo $tgl2 ?></label> <br>
					...
					<div class="row">
						<span> Perkara di Pengadilan Tata Usaha Negara </span>
                        <table id="datatable-responsive" class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
                        <thead>  
                        <tr> 
                            <td> No </td>
                            <td> <b> No. Perkara </b> </td>
                            <td> <b> Permasalahan </b> </td>
                            <td> <b> Pihak </b> </td>
                            <td> <b> Tanggal Sidang</b> </td>
							<td> <b> Acara Sidang</b> </td>
                        
						</tr>
                        </thead>
                        <tbody>
						<tr>	<?php $i=1; foreach ($get_data_tun as $tun) { ?>
					  
				
                            <td> <?php echo $i++ ?></td>
                            <td> <?php echo $tun->perkara_no ?> </td>
                            <td> <?php echo $tun->perkara_objek ?> </td>
                            <td> <?php echo $tun->perkara_penggugat?> - <?php echo $tun->perkara_tergugat?></td>
                            <td>
                                            <?php
                                                    $harinya = date("D", strtotime($tun->jadwal_tgl)); 
                                            ...
                                            ?>
                                            <?php echo $getHari?>, <?php echo date('d F Y ', strtotime($tun->jadwal_tgl));?>
                                            </td>
							<td> <?php echo $tun->jadwal_judul?></td>                        
                        </tr>
					<?php } ?>
					</tbody>
					</table>
					...
					<div class="row">
						<span> Perkara di Pengadilan Negeri </span>
                        <table id="datatable-responsive" class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
                        <thead>  
                        <tr> 
                            <td> No </td>
                        ...
                        <tbody>
						<tr>
						<?php $i=1; foreach ($get_data_pn as $pn) { ?>
                            <td> <?php echo $i++ ?></td>
                            <td> <?php echo $pn->perkara_no ?> </td>
                            <td> <?php echo $pn->perkara_objek ?> </td>
                            <td> <?php echo $pn->perkara_penggugat?> - <?php echo $pn->perkara_tergugat?></td>
                            <td>
                                            <?php
                                                    $harinya = date("D", strtotime($pn->jadwal_tgl)); 
                                            ...
                                            ?>
                                            <?php echo $getHari?>, <?php echo date('d F Y ', strtotime($pn->jadwal_tgl));?>
                                         
                                            </td>
							<td> <?php echo $pn->jadwal_judul?></td>
                        </tr>
					<?php } ?>						
                        </tbody>
                    </table>
					...
					<div class="row">
						<span> Perkara di Pengadilan Agama</span>
                        <table id="datatable-responsive" class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
                        <thead>  
                        <tr> 
                            <td> No </td>
                        ...
                        <tbody>
						<tr>
						<?php $i=1; foreach ($get_data_agama as $lain) { ?>
                            <td> <?php echo $i++ ?></td>
                            <td> <?php echo $lain->perkara_no ?> </td>
                            <td> <?php echo $lain->perkara_objek ?> </td>
                            <td> <?php echo $lain->perkara_penggugat?> - <?php echo $lain->perkara_tergugat?></td>
                            <td>
                                            <?php
                                                    $harinya = date("D", strtotime($lain->jadwal_tgl)); 
                                            ...
                                            ?>
                                            <?php echo $getHari?>, <?php echo date('d F Y ', strtotime($lain->jadwal_tgl));?>
                                         
                                            </td>
							<td> <?php echo $lain->jadwal_judul?></td>
				...
				<?php } ?>
					...
					<div class="row">
                        ...
                        <tbody>
						<tr>
						<?php $i=1; foreach ($get_data_lain as $pn) { ?>
                            <td> <?php echo $i++ ?></td>
                            <td> <?php echo $pn->perkara_no ?> </td>
                            <td> <?php echo $pn->perkara_objek ?> </td>
                            <td> <?php echo $pn->perkara_penggugat?> - <?php echo $pn->perkara_tergugat?></td>
